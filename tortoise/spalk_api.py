...
if __name__ == '__main__':
    ...
    gen, dbg_state = tts.tts_with_preset("Aside from a mishap at the third obstacle, one could say the overall performance was executed quite smoothly", voice_samples=reference_clips, preset='ultra_fast')
